    ...
    ScpiConnection(scpiinterface)
{
    ...
    m_pGainCorrection = new cJustData({m_pSCPIInterface, GainCorrOrder, 1.0, checkPermission, 8});
    m_pPhaseCorrection = new cJustData({m_pSCPIInterface, PhaseCorrOrder, 0.0, checkPermission, 8});
    m_pOffsetCorrection =  new cJustData({m_pSCPIInterface, OffsetCorrOrder, 0.0, checkPermission, 8});
}
...
void cCOM5003JustData::initSCPIConnection(QString leadingNodes)
{
    ...
    connect(delegate, &cSCPIDelegate::execute, this, &cCOM5003JustData::executeCommand);
