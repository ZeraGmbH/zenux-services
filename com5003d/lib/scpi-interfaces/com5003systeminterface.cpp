...
void Com5003SystemInterface::initSCPIConnection()
{
    ...
    addDelegate("SYSTEM:VERSION", "PCB", SCPI::isQuery, m_scpiInterface, SystemSystem::cmdVersionPCB, &m_allCtrlVersion); // why notification??
...
void Com5003SystemInterface::executeProtoScpi(int cmdCode, const ProtonetCommandPtr &protoCmd)
{
    switch (cmdCode)
    {
