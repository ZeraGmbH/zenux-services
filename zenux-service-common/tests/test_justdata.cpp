...
void test_justdata::init()
{
    ...
    justData = new AdjDataItemInterface({scpi, 0.1, [] (bool &enable) { enable =true; return true;}, digits}, &m_adjDataGroup->m_gainAdjData);
...
{
    AdjDataItemInterface *justDataReject = new AdjDataItemInterface({scpi, 0.1, [] (bool &enable) { enable=false; return true;}, digits}, &m_adjDataGroup->m_gainAdjData);
...
{
    AdjDataItemInterface *justDataReject = new AdjDataItemInterface({scpi, 0.1, [] (bool &enable) { enable=true; return false;}, digits}, &m_adjDataGroup->m_gainAdjData);
    justDataReject->initSCPIConnection("sens:m1:8V:corr:offset");
