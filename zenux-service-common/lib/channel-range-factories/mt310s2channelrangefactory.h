...
{
public:
    virtual QList<SenseChannelCommon*> createChannelAndRanges(const cSenseSettingsPtr &senseSettings,
...
private:
    ...
    static bool isInvalidAdjDataOrChannelRangeAvail(const AdjDataPtr &adjData, const QString &channelName, const QString &rangeName);
};
