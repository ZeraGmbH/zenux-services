...
void AdjDataItemScpi::initSCPIConnection(const QString &leadingNodes)
{
    addDelegate(QString("%1").arg(leadingNodes), "STATUS", SCPI::isCmdwP | SCPI::isQuery, m_scpiInterface, JustStatus);

    const QString adjLeadNodes = appendTrailingColonOnNonEmptyParentNodes(leadingNodes); // upper lines do not expect trailing ':' - we should use lists for leading nodes...
    addDelegate(QString("%1COEFFICIENT").arg(adjLeadNodes), "0", SCPI::isCmdwP | SCPI::isQuery, m_scpiInterface, JustCoefficient0);
    addDelegate(QString("%1COEFFICIENT").arg(adjLeadNodes), "1", SCPI::isCmdwP | SCPI::isQuery, m_scpiInterface, JustCoefficient1);
    addDelegate(QString("%1COEFFICIENT").arg(adjLeadNodes), "2", SCPI::isCmdwP | SCPI::isQuery, m_scpiInterface, JustCoefficient2);
    addDelegate(QString("%1COEFFICIENT").arg(adjLeadNodes), "3", SCPI::isCmdwP | SCPI::isQuery, m_scpiInterface, JustCoefficient3);
    addDelegate(QString("%1NODE").arg(adjLeadNodes), "0", SCPI::isCmdwP | SCPI::isQuery, m_scpiInterface, JustNode0);
    addDelegate(QString("%1NODE").arg(adjLeadNodes), "1", SCPI::isCmdwP | SCPI::isQuery, m_scpiInterface, JustNode1);
    addDelegate(QString("%1NODE").arg(adjLeadNodes), "2", SCPI::isCmdwP | SCPI::isQuery, m_scpiInterface, JustNode2);
    addDelegate(QString("%1NODE").arg(adjLeadNodes), "3", SCPI::isCmdwP | SCPI::isQuery, m_scpiInterface, JustNode3);
}
