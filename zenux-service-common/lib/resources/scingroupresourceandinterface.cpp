...
QString ScInGroupResourceAndInterface::scpiReadVersion(const QString &sInput)
{
...
QString ScInGroupResourceAndInterface::m_ReadChannelCatalog(const QString &sInput)
{
    cSCPICommand cmd = sInput;
    if (cmd.isQuery()) {
        int i;
