...
public:
    ...
    quint32 setMMode(const QString &mmode);
    ...
    quint32 registerNotifier(const QString &query, int notifyId, bool notifyWithValue); // register for notification on change
