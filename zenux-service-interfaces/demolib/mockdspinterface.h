...
public:
    ...
    void fireActValInterrupt(const QVector<float> &actualValues, int irqNo);
    quint32 dataAcquisition(DspVarGroupClientInterface* varGroup, int limitValueCount = 0) override;
