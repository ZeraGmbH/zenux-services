...
{
    m_channelList = setChannelAndRangesMt310s2(senseSettings,
                                        m_adjData,
                                        m_scpiInterface,
                                        m_ctrlFactory);
...
QList<SenseChannelCommon*> Mt310s2SenseInterface::setChannelAndRangesMt310s2(cSenseSettings* senseSettings,
                                                                             AdjDataPtr adjData,
...
QList<SenseChannelCommon *> Mt310s2SenseInterface::setChannelAndRangesMt581s2(cSenseSettings *senseSettings,
                                                                              AdjDataPtr adjData,
                                                                              std::shared_ptr<cSCPI> scpi,
                                                                              AbstractFactoryI2cCtrlPtr ctrlFactory)
{
    qInfo("Set channels/ranges for MT581s2");
    constexpr quint16 rangeFlagsDevice = modeAC | modeADJ | Direct;
    constexpr quint16 rangeFlagsIntern = modeADJ | Direct;
