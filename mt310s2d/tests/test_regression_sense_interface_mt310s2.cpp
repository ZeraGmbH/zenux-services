...
void test_regression_sense_interface_mt310s2::constantRangeValuesI()
{
    ...
    QVERIFY(TestLogHelpers::compareAndLogOnDiffJsonFile(":/mt310s2/all-ranges-i.json", jsonDumped));
}
...
void test_regression_sense_interface_mt310s2::constantRangeValuesU()
{
    ...
    QByteArray jsonDumped = SenseRegressionHelper::genJsonConstantValuesAllRanges(channelSettings, m_pcbIFace.get());
    QVERIFY(TestLogHelpers::compareAndLogOnDiffJsonFile(":/mt310s2/all-ranges-u.json", jsonDumped));
}
...
void test_regression_sense_interface_mt310s2::constantRangeValuesIModeAdj()
{
    ...
    QByteArray jsonDumped = SenseRegressionHelper::genJsonConstantValuesAllRanges(channelSettings, m_pcbIFace.get());
    QVERIFY(TestLogHelpers::compareAndLogOnDiffJsonFile(":/mt310s2/all-ranges-i-adj-mode.json", jsonDumped));
}
...
void test_regression_sense_interface_mt310s2::constantRangeValuesUModeAdj()
{
    ...
    QByteArray jsonDumped = SenseRegressionHelper::genJsonConstantValuesAllRanges(channelSettings, m_pcbIFace.get());
    QVERIFY(TestLogHelpers::compareAndLogOnDiffJsonFile(":/mt310s2/all-ranges-u-adj-mode.json", jsonDumped));
}
...
void test_regression_sense_interface_mt310s2::constantRangeValuesIModeHf()
{
    ...
    QByteArray jsonDumped = SenseRegressionHelper::genJsonConstantValuesAllRanges(channelSettings, m_pcbIFace.get());
    QVERIFY(TestLogHelpers::compareAndLogOnDiffJsonFile(":/mt310s2/all-ranges-i-hf-mode.json", jsonDumped));
}
...
void test_regression_sense_interface_mt310s2::constantRangeValuesUModeHf()
{
    ...
    QByteArray jsonDumped = SenseRegressionHelper::genJsonConstantValuesAllRanges(channelSettings, m_pcbIFace.get());
    QVERIFY(TestLogHelpers::compareAndLogOnDiffJsonFile(":/mt310s2/all-ranges-u-hf-mode.json", jsonDumped));
}
...
void test_regression_sense_interface_mt310s2::constantRangeValuesAllClampsIL3()
{
    ...
    QVERIFY(TestLogHelpers::compareAndLogOnDiffJsonFile(":/mt310s2/all-ranges-all-clamps-il3.json", jsonDumped));
}
...
void test_regression_sense_interface_mt310s2::constantRangeValuesAllClampsIAUX()
{
    ...
    QVERIFY(TestLogHelpers::compareAndLogOnDiffJsonFile(":/mt310s2/all-ranges-all-clamps-iaux.json", jsonDumped));
}
...
void test_regression_sense_interface_mt310s2::constantRangeValuesAllClampsUAUX()
{
    ...
    QVERIFY(TestLogHelpers::compareAndLogOnDiffJsonFile(":/mt310s2/all-ranges-all-clamps-uaux.json", jsonDumped));
}
