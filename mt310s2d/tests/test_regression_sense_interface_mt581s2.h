#ifndef TEST_REGRESSION_SENSE_INTERFACE_MT581S2_H
#define TEST_REGRESSION_SENSE_INTERFACE_MT581S2_H
...
class test_regression_sense_interface_mt581s2 : public QObject
{
    Q_OBJECT
private slots:
    void initTestCase();
...
#endif // TEST_REGRESSION_SENSE_INTERFACE_MT581S2_H
