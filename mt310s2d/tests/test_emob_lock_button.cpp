...
void test_emob_lock_button::init()
{
    ...
    AbstractHotPluggableControllerContainerPtr emobControllerContainer = std::make_unique<HotPluggableControllerContainer>(testPcbServer->getSettings()->getI2cSettings(),
                                                                                                                   ctrlFactory);
