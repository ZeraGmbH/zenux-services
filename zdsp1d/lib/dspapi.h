...
static constexpr int DSP_INTERRUPT_PARAM_BUFFER_LEN = 20;
static constexpr int DSP_MAX_PENDING_INTERRUPT_COUNT = DSP_INTERRUPT_PARAM_BUFFER_LEN-1; // 1st is counter!!!
